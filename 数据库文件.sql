...
ALTER TABLE `flask_for_movie`.`user1` ADD UNIQUE INDEX `uk_login_name` (`login_name`)

flask-sqlacodegen 'mysql://flask_for_movie:flask_for_movie@47.115.163.10/flask_for_movie' --tables user1 --outfile "common/models/user.py" --flask
